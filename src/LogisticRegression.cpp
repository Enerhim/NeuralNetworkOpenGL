...
void LogisticRegression::initWeights(size_t size) {
...
double LogisticRegression::inference(std::vector<double> x) {
  return sigmoid(dotProduct(x, m_weights) + m_bias);
}

std::vector<double>
LogisticRegression::computeGradient(std::vector<std::vector<double>> X,
                                    std::vector<double> y) {
...
void LogisticRegression::fit(std::vector<std::vector<double>> X,
